...
private val logger: Logger = LoggerFactory.getLogger("AWSClusterEngineEngine")
...
class AWSClusterEngine(
    ...
    override suspend fun isClusterInited(io: ClusterEngineIO): Boolean {
        ...
        return currentInstances.size == clusterSize
    }
        ...
        val instances =
            response.reservations
                ...
                ?.filter { instance ->
                    ...
                    (stateName == "running" || stateName == "stopped" || stateName == "pending") &&
    ...
    override suspend fun startInstance(
        ...
        val instances = getClusterInstances(io)
        val request =
            StartInstancesRequest {
                instanceIds = instances.map { it.id }
            }
